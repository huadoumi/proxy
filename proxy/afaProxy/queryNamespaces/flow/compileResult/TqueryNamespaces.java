package afaProxy.queryNamespaces;
 ...
 *
 */
public class TqueryNamespaces extends JScript {
    protected INode startStep;
    protected long startTime;
     
    public TqueryNamespaces(JavaDict __REQ__, JavaDict __RSP__) {
    ...
    public synchronized INode execute() {
        ...
        if (startStep == null) {
            ...
            log(LogLevel.INFO, "开始交易  queryNamespaces:查询k8s所有namespace");
            printTrace();
        ...
        if (step == EndNode.SUSPEND_END) {
            ...
            log(LogLevel.INFO, "结束交易 queryNamespaces");
