package afaProxy.__ParamUpdater__;
 ...
 * 交易描述：服务参数更新场景 <br/>
 *
 * 创建时间：2019-06-17 08:15 <br/>
 *
 * 修改时间：2019-06-17 08:15 <br/>
 *
 * @author  <br/>
 * @version 1.0 <br/>
 *
 */
public class T__ParamUpdater__ extends JScript {
    protected INode startStep;
    protected long startTime;
     
    public T__ParamUpdater__(JavaDict __REQ__, JavaDict __RSP__) {
    ...
    public synchronized INode execute() {
        ...
        if (startStep == null) {
            ...
            __REQ__.setItem("__TRADENAME__", "服务参数更新场景");
            log(LogLevel.INFO, "log start:" + uuid);
            log(LogLevel.INFO, "开始交易  __ParamUpdater__:服务参数更新场景");
            printTrace();
        ...
        if (step == EndNode.SUSPEND_END) {
            ...
            log(LogLevel.INFO, "结束交易 __ParamUpdater__");
    ...
    protected class Step1 implements INode {
        ...
        public INode execute() {
            if (startNode == null) {
            	startTime = System.currentTimeMillis();
                log(LogLevel.valueOf(2), "Step1 update");
                startNode = new Node1();
            ...
            gatherStat("Step1", "update", 1, startTime);
